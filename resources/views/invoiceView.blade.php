...
<br><br>
    ...
    @foreach ($sold_item_success as $sold)
    ...
    @if(isset($invoice_success->payment_method))

    <h1>Hello, {{$invoice_success->customer_name}}</h1>
    ...
    <tr>
        <form action="{{route('sellProductConfirm')}}" method="post"> <center>
            ...
            <input type="checkbox" name="pay_method" value="card">Card
            <input type="checkbox" name="pay_method" value="cash">Cash 
            &emsp;&emsp;&emsp;&emsp;
